package at.adesso.leagueapi.gamedataservice.infrastructure.adapter.riot.summoners.api;
...
@Component
public class RiotSummonerApi extends AbstractRiotAdapter {
    ...
    protected RiotSummonerApi(final RiotApiConfigurationProperties properties,
