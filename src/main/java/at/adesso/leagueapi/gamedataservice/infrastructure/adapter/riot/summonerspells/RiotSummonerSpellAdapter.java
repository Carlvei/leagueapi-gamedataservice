...
public class RiotSummonerSpellAdapter {
    ...
    public RiotSummonerSpellAdapter(@Value("${riot.api.data-dragon.types.data.subjects.summoner-spells.url}") final String summonerSpellsUrl,
    ...
    private List<SummonerSpellDto> extractSummonerSpellsAsList(final SummonerSpellsResponse summonerSpellsResponse) {
        ...
        //  Maybe find a solution that wont kill me if stefan sees it.
