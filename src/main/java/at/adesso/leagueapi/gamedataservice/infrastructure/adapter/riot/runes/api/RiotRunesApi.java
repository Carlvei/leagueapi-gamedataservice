package at.adesso.leagueapi.gamedataservice.infrastructure.adapter.riot.runes.api;
...
@Component
public class RiotRunesApi {

    private final String runesJsonUrl;
    private final RestTemplate restTemplate;
    private final RunesDtoMapper mapper;

    public RiotRunesApi(@Value("${riot.api.data-dragon.types.data.subjects.runes.url}") final String runesJsonUrl,
